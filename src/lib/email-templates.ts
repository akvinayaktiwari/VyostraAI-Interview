  ...
  <div style="max-width:600px;margin:0 auto;padding:40px 20px">
    ...
    <div style="text-align:center;margin-bottom:32px">
      <div style="display:inline-flex;align-items:center;gap:8px">
        <div style="width:32px;height:32px;background:#7c3aed;background-image:linear-gradient(135deg,#7c3aed,#a855f7);border-radius:12px;display:inline-flex;align-items:center;justify-content:center">
    ...
    generate: (v) => ({
      ...
      html: wrapHtml(`
        ...
        <div style="text-align:center;margin:0 0 24px">
          <a href="${escapeHtml(v.interviewUrl)}" style="display:inline-block;background:#7c3aed;background-image:linear-gradient(90deg,#7c3aed,#a855f7);color:white;font-weight:600;font-size:15px;padding:14px 40px;border-radius:8px;text-decoration:none">
