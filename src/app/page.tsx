                    ...
                    className={`w-8 h-8 text-xs rounded-full transition-all duration-150 ${
                      isStart(day) || isEnd(day)
                        ...
                        : isInRange(day)
                          ...
                          : isToday(day)
                            ? "border border-violet-300 text-violet-600 font-medium"
  ...
  return (
    <div>
      <button
        ref={btnRef}
        onClick={handleOpen}
        className={`flex items-center gap-2 px-3 py-2 text-sm border rounded-xl transition-all duration-200 whitespace-nowrap ${
          tempFrom ? "border-violet-300 bg-violet-50 text-violet-700" : "border-gray-200 bg-white text-gray-500 hover:bg-gray-50"
        }`}
      >
...
export default function DashboardPage() {
  ...
  const SortIcon = ({ field }: { field: SortField }) => (
    <svg
      className={`w-3.5 h-3.5 ml-1 inline-block transition-all duration-200 ${sortField === field ? "text-violet-600" : "text-gray-400"} ${sortField === field && sortDir === "asc" ? "rotate-180" : ""}`}
      fill="none"
      viewBox="0 0 24 24"
      stroke="currentColor"
    >
    ...
    <DashboardLayout>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 mb-8">
          {[
            { label: "Total", value: stats.total, iconBg: "bg-gradient-to-br from-violet-600 to-purple-500 shadow-md shadow-violet-200/60", iconColor: "text-white", icon: "M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10", delay: "" },
            ...
            { label: "Completed", value: stats.completed, iconBg: "bg-emerald-50", iconColor: "text-emerald-600", icon: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z", delay: "delay-3" },
            { label: "Avg Score", value: stats.avgScore, iconBg: "bg-violet-50", iconColor: "text-violet-600", icon: "M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z", delay: "delay-4" },
          ].map((stat) => (
            <div key={stat.label} className={`card-hover p-4 animate-fade-in-up ${stat.delay}`}>
              ...
              <p className="font-display text-3xl font-extrabold text-gray-900 animate-count-up">{stat.value}</p>
            </div>
          ))}
        </div>
        ...
        <div className="flex flex-col gap-3 mb-6 animate-fade-in-up delay-3">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full px-4 py-2.5 pl-11 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-violet-100 focus:border-violet-400 bg-white text-gray-700 transition-all duration-200 placeholder:text-gray-400"
              />
            </div>
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 hover:shadow-sm disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 whitespace-nowrap"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            <div className="flex items-center gap-1 rounded-xl p-1 border border-gray-200 bg-gray-50/50">
              {[
                { key: "all", label: "All" },
        ...
        {loading ? (
          ...
          <div className="card p-16 text-center animate-scale-in">
            ...
            <svg className="w-32 h-32 mx-auto mb-6 text-gray-200" viewBox="0 0 120 120" fill="none">
              ...
              <rect x="30" y="78" width="24" height="8" rx="4" fill="#a78bfa" opacity="0.3" />
              <circle cx="90" cy="25" r="12" fill="#a78bfa" opacity="0.1" />
              <path d="M87 25l2 2 4-4" stroke="#a78bfa" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" opacity="0.5" />
            </svg>
          ...
          <div className="card p-16 text-center animate-scale-in">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-violet-600 bg-violet-50 rounded-xl hover:bg-violet-100 transition-all duration-200"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        >
                          ...
                          <td className="px-6 py-4">
                            <div className="flex items-center gap-2">
                              <Link
                                href={`/dashboard/${interview.id}`}
                                className="px-3 py-1.5 text-xs font-medium text-violet-600 bg-violet-50 rounded-xl hover:bg-violet-100 transition-all duration-200"
                              >
                                View
                              </Link>
                              {interview.transcript.length > 0 && (
                                <button
                                  ...
                                  className="px-3 py-1.5 text-xs font-medium text-gray-700 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 hover:shadow-sm disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
                                >
                ...
                {totalPages > 1 && (
                  <div className="flex items-center gap-1">
                    <button
                      ...
                      className="px-3 py-1.5 rounded-xl text-xs font-medium bg-white text-gray-700 border border-gray-200 hover:bg-gray-50 hover:shadow-sm disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
                    >
                      Prev
                    </button>
                    {(() => {
