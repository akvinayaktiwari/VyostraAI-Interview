...
function SectionHeader({ step, title, subtitle }: { step: number; title: string; subtitle: string }) {
  return (
    <div className="flex items-start gap-3 mb-4">
      <div className="w-7 h-7 rounded-full bg-violet-50 text-violet-600 flex items-center justify-center text-xs font-bold shrink-0 mt-0.5">
        {step}
      </div>
      <div>
    ...
    <DashboardLayout>
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-8 animate-fade-in-down">
          <h1 className="text-2xl font-extrabold text-gray-900">Create Interview</h1>
        ...
        {interviewLink ? (
              ...
              {[...Array(8)].map((_, i) => (
                <div
                  ...
                  style={{
                    ...
                    backgroundColor: ["#a78bfa", "#34d399", "#fbbf24"][i % 3],
                    opacity: 0.3,
            ...
            {bulkResults.length > 0 ? (
              <div className="relative text-left space-y-4">
                ...
                <div className="space-y-2 max-h-80 overflow-y-auto">
                  {bulkResults.map((r, i) => (
                    <div key={i} className={`flex items-center gap-3 p-3 rounded-xl ${r.error ? "bg-red-50" : "bg-gray-50"}`}>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="card p-6 animate-fade-in-up border-l-4 border-l-violet-500">
              ...
              <div className="space-y-4">
                ...
                <button type="button" onClick={addCandidate}
                  className="flex items-center gap-2 text-sm text-violet-600 hover:text-violet-800 transition">
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                <div>
                  ...
                  <div
                    ...
                    className={`border-2 border-dashed rounded-xl text-center cursor-pointer transition-all duration-300
                      ${isDragging ? "border-violet-400 bg-violet-50 scale-[1.02] shadow-lg shadow-violet-100"
                        : file ? "border-green-300 bg-green-50 p-4"
                        : "border-gray-300 hover:border-violet-300 hover:bg-violet-50/30 p-6"}`}
                  >
                    ...
                    {file ? (
                      ...
                      <div className="py-2">
                        ...
                        <p className="text-sm text-gray-600 mb-1">Drop resume here or <span className="text-violet-600 font-medium">browse files</span></p>
                      ...
                      <button key={area} type="button" onClick={() => toggleFocus(area)}
                        className={`px-3 py-1.5 rounded-xl text-xs font-medium transition-all duration-200
                          ${focusAreas.includes(area)
                            ? "bg-gradient-to-r from-violet-600 to-purple-500 text-white shadow-sm shadow-violet-200"
                            : "bg-gray-50 text-gray-500 border border-gray-200 hover:border-violet-200 hover:bg-violet-50 hover:text-violet-600"}`}>
                        {focusAreas.includes(area) && (
                ...
                {questionBanks.length > 0 && (
                  <div>
                    ...
                    {selectedBankId && (() => {
                      ...
                      return qs.length > 0 ? (
                        <div className="mt-2 space-y-1 max-h-[100px] overflow-y-auto rounded-xl border border-gray-100 p-2 bg-gray-50">
                          {qs.map((q, i) => (
