    ...
    <DashboardLayout>
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8 animate-fade-in-down">
          <div>
            <h1 className="text-2xl font-extrabold text-gray-900">Question Banks</h1>
        ...
        {loading ? (
          ...
          <div className="card p-16 text-center animate-scale-in">
            <svg className="w-28 h-28 mx-auto mb-6 text-gray-200" viewBox="0 0 120 120" fill="none">
              ...
              <circle cx="85" cy="80" r="18" fill="#a78bfa" opacity="0.15" stroke="#a78bfa" strokeWidth="2" />
              <path d="M82 80h6M85 77v6" stroke="#a78bfa" strokeWidth="2" strokeLinecap="round" opacity="0.5" />
            </svg>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-3 text-sm text-gray-500 mb-3">
                    ...
                    <span className="ml-auto inline-flex items-center justify-center px-2 py-0.5 rounded-full text-[10px] font-bold bg-violet-50 text-violet-600 border border-violet-100">
                      {qCount}
                    </span>
                  </div>
                  {/* Question preview */}
              ...
              <div>
                ...
                <div className="space-y-2 max-h-[200px] overflow-y-auto">
                  {questions.map((q, i) => (
                    <div
                      key={i}
                      className="flex items-start gap-3 px-3 py-2.5 rounded-xl bg-gray-50 border border-gray-100 group animate-fade-in-left"
