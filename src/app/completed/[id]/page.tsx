...
import { VyostraWordmark } from "@/components/VyostraLogo";
      ...
      <div className="w-full max-w-lg relative z-10">
        ...
        <div className="text-center mb-6 animate-fade-in-down">
          <div className="inline-flex items-center">
            <VyostraWordmark size={28} />
          </div>
        </div>

        <div className="bg-white rounded-2xl border border-gray-100 shadow-2xl shadow-violet-100/60 p-8 sm:p-10 text-center animate-fade-in-up">
          ...
          <h1 className="text-2xl font-extrabold text-gray-900 mb-2 animate-fade-in-up" style={{ animationDelay: "300ms", opacity: 0 }}>
            Interview Complete
          </h1>
          ...
          <div className="bg-gray-50 rounded-xl border border-gray-100 p-5 mb-8 text-left space-y-4 animate-fade-in-up" style={{ animationDelay: "500ms", opacity: 0 }}>
            <div className="flex items-center gap-3">
              <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-violet-50">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="h-4 w-4 text-violet-600">
          ...
          <div className="rounded-xl border border-violet-100 bg-violet-50/50 p-5 mb-8 animate-slide-in-up" style={{ animationDelay: "600ms", opacity: 0 }}>
        ...
        <p className="text-center text-xs text-gray-400 mt-6 animate-fade-in" style={{ animationDelay: "800ms", opacity: 0 }}>
          Powered by Vyostra AI Interview
        </p>
      </div>
    </div>
  );
