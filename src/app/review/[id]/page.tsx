    ...
    return (
      <DashboardLayout>
        <div className="card p-8 text-center max-w-md mx-auto space-y-4 animate-scale-in">
          ...
          <a href={`/dashboard/${id}`} className="block text-xs text-gray-500 hover:text-violet-600 transition mt-2">
            ...
            {activeTab === "evidence" && (
              <div className="space-y-3 animate-fade-in">
                {scorecard.evidence.map((ev, i) => (
                  <div
                    key={i}
                    className="bg-gray-50 rounded-xl p-4 space-y-2 border border-gray-100 animate-slide-in-up"
              ...
              <div className="space-y-2 animate-fade-in">
                {proctoring.length === 0 ? (
                  ...
                  proctoring.map((event, i) => (
                    <div
                      key={i}
                      className="flex items-center gap-3 bg-gray-50 rounded-xl px-4 py-3 border border-gray-100 animate-fade-in-left"
